...
# ############################################################
range_num_d2d_pairs = [2, 4, 6, 8, 10]
...
for prin in range_num_d2d_pairs:
    ...
    for Mon in xrange(max_chan_realizaion):
        try:
            ...
            for i in xrange(num_d2d_pairs):
                harvested_power = (1 - 1 / theta_ini.value) * eta*power_UAV*uav_to_d2d_gains[i]

            vec_harvested_power.append(harvested_power)
    ...
    v4 = sp.array(vec_harvested_power)
    vec_v4.append(sp.mean(v4))
